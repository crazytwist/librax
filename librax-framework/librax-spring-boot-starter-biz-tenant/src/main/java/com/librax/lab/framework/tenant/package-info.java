 ...
 *      1）Spring Async：
 *          {@link com.librax.lab.framework.quartz.config.LibraxAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 LibraxSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package com.librax.lab.framework.tenant;
