package com.librax.lab.framework.tracer.config;

import com.librax.lab.framework.common.enums.WebFilterOrderEnum;
import com.librax.lab.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "librax.tracer", value = "enable", matchIfMissing = true)
public class LibraxTracerAutoConfiguration {
