package com.librax.lab.framework.ratelimiter.config;

import com.librax.lab.framework.ratelimiter.core.aop.RateLimiterAspect;
import com.librax.lab.framework.ratelimiter.core.keyresolver.RateLimiterKeyResolver;
import com.librax.lab.framework.ratelimiter.core.keyresolver.impl.*;
import com.librax.lab.framework.ratelimiter.core.redis.RateLimiterRedisDAO;
...
public class LibraxRateLimiterConfiguration {
