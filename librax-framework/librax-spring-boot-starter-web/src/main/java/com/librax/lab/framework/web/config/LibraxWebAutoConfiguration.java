package com.librax.lab.framework.web.config;
...
import com.librax.lab.framework.web.core.filter.CacheRequestBodyFilter;
import com.librax.lab.framework.web.core.filter.DemoFilter;
import com.librax.lab.framework.web.core.handler.GlobalExceptionHandler;
import com.librax.lab.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class LibraxWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "librax.demo", havingValue = "true")
