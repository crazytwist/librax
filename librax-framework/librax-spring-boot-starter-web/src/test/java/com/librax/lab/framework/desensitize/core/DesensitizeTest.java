package com.librax.lab.framework.desensitize.core;

import com.librax.lab.framework.common.util.json.JsonUtils;
import com.librax.lab.framework.desensitize.core.annotation.Address;
import com.librax.lab.framework.desensitize.core.regex.annotation.EmailDesensitize;
import com.librax.lab.framework.desensitize.core.regex.annotation.RegexDesensitize;
import com.librax.lab.framework.desensitize.core.slider.annotation.*;
import lombok.Data;
...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("一南");
        ...
        desensitizeDemo.setRegex("你好，我是一南");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("一南");
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "一南", replacer = "*")
