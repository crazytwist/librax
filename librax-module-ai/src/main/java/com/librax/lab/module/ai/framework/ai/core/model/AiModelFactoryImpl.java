package com.librax.lab.module.ai.framework.ai.core.model;
...
import com.librax.lab.framework.common.util.spring.SpringUtils;
import com.librax.lab.module.ai.enums.model.AiPlatformEnum;
import com.librax.lab.module.ai.framework.ai.config.AiAutoConfiguration;
import com.librax.lab.module.ai.framework.ai.config.LibraxAiProperties;
...
import com.librax.lab.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageApi;
import com.librax.lab.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageModel;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            LibraxAiProperties.Midjourney properties = SpringUtil.getBean(LibraxAiProperties.class)
                    .getMidjourney();
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#douBaoChatClient(LibraxAiProperties)}
     */
    private ChatModel buildDouBaoChatModel(String apiKey) {
        LibraxAiProperties.DouBao properties = new LibraxAiProperties.DouBao()
                .setApiKey(apiKey);
        return new AiAutoConfiguration().buildDouBaoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#hunYuanChatClient(LibraxAiProperties)}
     */
    private ChatModel buildHunYuanChatModel(String apiKey, String url) {
        LibraxAiProperties.HunYuan properties = new LibraxAiProperties.HunYuan()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildHunYuanChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#siliconFlowChatClient(LibraxAiProperties)}
     */
    private ChatModel buildSiliconFlowChatModel(String apiKey) {
        LibraxAiProperties.SiliconFlow properties = new LibraxAiProperties.SiliconFlow()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#xingHuoChatClient(LibraxAiProperties)}
     */
    private static XingHuoChatModel buildXingHuoChatModel(String key) {
        ...
        LibraxAiProperties.XingHuo properties = new LibraxAiProperties.XingHuo()
                .setAppKey(keys.get(0)).setSecretKey(keys.get(1));
        return new AiAutoConfiguration().buildXingHuoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#baiChuanChatClient(LibraxAiProperties)}
     */
    private BaiChuanChatModel buildBaiChuanChatModel(String apiKey) {
        LibraxAiProperties.BaiChuan properties = new LibraxAiProperties.BaiChuan()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#buildGeminiChatClient(LibraxAiProperties.Gemini)}
     */
    private static GeminiChatModel buildGeminiChatModel(String apiKey) {
        LibraxAiProperties.Gemini properties = SpringUtil.getBean(LibraxAiProperties.class)
    ...
    private ChatModel buildGrokChatModel(String apiKey,String url) {
        LibraxAiProperties.Grok properties = new LibraxAiProperties.Grok()
                .setBaseUrl(url)
                .setApiKey(apiKey);
