package com.librax.lab.module.ai.service.chat;
...
import com.librax.lab.framework.tenant.core.util.TenantUtils;
import com.librax.lab.module.ai.controller.admin.chat.vo.message.AiChatMessagePageReqVO;
import com.librax.lab.module.ai.controller.admin.chat.vo.message.AiChatMessageRespVO;
import com.librax.lab.module.ai.controller.admin.chat.vo.message.AiChatMessageSendReqVO;
import com.librax.lab.module.ai.controller.admin.chat.vo.message.AiChatMessageSendRespVO;
import com.librax.lab.module.ai.dal.dataobject.chat.AiChatConversationDO;
import com.librax.lab.module.ai.dal.dataobject.chat.AiChatMessageDO;
import com.librax.lab.module.ai.dal.dataobject.knowledge.AiKnowledgeDocumentDO;
import com.librax.lab.module.ai.dal.dataobject.model.AiChatRoleDO;
import com.librax.lab.module.ai.dal.dataobject.model.AiModelDO;
import com.librax.lab.module.ai.dal.dataobject.model.AiToolDO;
import com.librax.lab.module.ai.dal.mysql.chat.AiChatMessageMapper;
import com.librax.lab.module.ai.enums.ErrorCodeConstants;
import com.librax.lab.module.ai.enums.model.AiPlatformEnum;
import com.librax.lab.module.ai.framework.ai.core.webserch.AiWebSearchClient;
import com.librax.lab.module.ai.framework.ai.core.webserch.AiWebSearchRequest;
import com.librax.lab.module.ai.framework.ai.core.webserch.AiWebSearchResponse;
import com.librax.lab.module.ai.service.knowledge.AiKnowledgeDocumentService;
import com.librax.lab.module.ai.service.knowledge.AiKnowledgeSegmentService;
import com.librax.lab.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchReqBO;
import com.librax.lab.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchRespBO;
import com.librax.lab.module.ai.service.model.AiChatRoleService;
import com.librax.lab.module.ai.service.model.AiModelService;
import com.librax.lab.module.ai.service.model.AiToolService;
import com.librax.lab.module.ai.util.AiUtils;
import com.librax.lab.module.ai.util.FileTypeUtils;
...
import static com.librax.lab.framework.common.pojo.CommonResult.error;
...
import static com.librax.lab.module.ai.enums.ErrorCodeConstants.CHAT_CONVERSATION_NOT_EXISTS;
import static com.librax.lab.module.ai.enums.ErrorCodeConstants.CHAT_MESSAGE_NOT_EXIST;
...
public class AiChatMessageServiceImpl implements AiChatMessageService {
    ...
    @Autowired(required = false) // 由于 librax.ai.web-search.enable 配置项，可以关闭 AiWebSearchClient 的功能，所以这里只能不强制注入
    private AiWebSearchClient webSearchClient;

    @SuppressWarnings("SpringJavaAutowiredFieldsWarningInspection")
    @Autowired(required = false) // 由于 librax.ai.mcp.client.enable 配置项，可以关闭 McpSyncClient 的功能，所以这里只能不强制注入
