package com.librax.lab.module.bpm.service.task;
...
import com.librax.lab.framework.common.util.date.DateUtils;
import com.librax.lab.framework.common.util.json.JsonUtils;
import com.librax.lab.framework.common.util.object.ObjectUtils;
import com.librax.lab.framework.common.util.object.PageUtils;
import com.librax.lab.framework.datapermission.core.annotation.DataPermission;
import com.librax.lab.module.bpm.api.task.dto.BpmProcessInstanceCreateReqDTO;
import com.librax.lab.module.bpm.controller.admin.definition.vo.model.BpmModelMetaInfoVO;
import com.librax.lab.module.bpm.controller.admin.definition.vo.model.simple.BpmSimpleModelNodeVO;
import com.librax.lab.module.bpm.controller.admin.task.vo.instance.*;
import com.librax.lab.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNodeTask;
import com.librax.lab.module.bpm.controller.admin.task.vo.task.BpmTaskRespVO;
import com.librax.lab.module.bpm.convert.task.BpmProcessInstanceConvert;
import com.librax.lab.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import com.librax.lab.module.bpm.dal.redis.BpmProcessIdRedisDAO;
import com.librax.lab.module.bpm.enums.ErrorCodeConstants;
import com.librax.lab.module.bpm.enums.definition.BpmModelTypeEnum;
import com.librax.lab.module.bpm.enums.definition.BpmSimpleModelNodeTypeEnum;
import com.librax.lab.module.bpm.enums.task.BpmProcessInstanceStatusEnum;
import com.librax.lab.module.bpm.enums.task.BpmReasonEnum;
import com.librax.lab.module.bpm.enums.task.BpmTaskStatusEnum;
import com.librax.lab.module.bpm.framework.flowable.core.candidate.BpmTaskCandidateInvoker;
import com.librax.lab.module.bpm.framework.flowable.core.enums.BpmTaskCandidateStrategyEnum;
import com.librax.lab.module.bpm.framework.flowable.core.enums.BpmnModelConstants;
import com.librax.lab.module.bpm.framework.flowable.core.enums.BpmnVariableConstants;
import com.librax.lab.module.bpm.framework.flowable.core.event.BpmProcessInstanceEventPublisher;
import com.librax.lab.module.bpm.framework.flowable.core.util.BpmHttpRequestUtils;
import com.librax.lab.module.bpm.framework.flowable.core.util.BpmnModelUtils;
import com.librax.lab.module.bpm.framework.flowable.core.util.FlowableUtils;
import com.librax.lab.module.bpm.framework.flowable.core.util.SimpleModelUtils;
import com.librax.lab.module.bpm.service.definition.BpmProcessDefinitionService;
import com.librax.lab.module.bpm.service.message.BpmMessageService;
import com.librax.lab.module.system.api.dept.DeptApi;
import com.librax.lab.module.system.api.dept.dto.DeptRespDTO;
import com.librax.lab.module.system.api.user.AdminUserApi;
import com.librax.lab.module.system.api.user.dto.AdminUserRespDTO;
...
import static com.librax.lab.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNode;
import static com.librax.lab.module.bpm.enums.ErrorCodeConstants.*;
import static com.librax.lab.module.bpm.framework.flowable.core.enums.BpmnModelConstants.START_USER_NODE_ID;
import static com.librax.lab.module.bpm.framework.flowable.core.util.BpmnModelUtils.parseNodeType;
...
public class BpmProcessInstanceServiceImpl implements BpmProcessInstanceService {
    ...
    @DataPermission(enable = false) // 关闭数据权限，避免查询不到用户数据。相关案例：https://gitee.com/zhijiantianya/librax-cloud/issues/ID1UYA
