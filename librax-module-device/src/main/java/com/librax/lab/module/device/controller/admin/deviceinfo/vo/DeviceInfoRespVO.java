...
@Schema(description = "管理后台 - 设备基本信息表，一行一台物理设备 [lab_device_] Response VO")
@Data
...
public class DeviceInfoRespVO {
    ...
    @ExcelProperty("串口号，如 COM3 / /dev/ttyUSB0")
    private String serialPort;

    @Schema(description = "波特率，如 9600 / 115200")
    @ExcelProperty("波特率，如 9600 / 115200")
