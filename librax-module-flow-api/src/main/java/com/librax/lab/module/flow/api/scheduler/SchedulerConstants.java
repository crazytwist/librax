package com.librax.lab.module.flow.api.scheduler;
...
public final class SchedulerConstants {
    ...
    /**
     * inputParams 里存 resourceId 的 key,执行器从这里取设备 ID
     */
    public static final String CONTEXT_KEY_RESOURCE_ID = "_resourceId";
}
