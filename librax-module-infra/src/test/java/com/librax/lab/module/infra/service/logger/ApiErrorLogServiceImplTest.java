package com.librax.lab.module.infra.service.logger;
...
import com.librax.lab.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import com.librax.lab.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import com.librax.lab.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import com.librax.lab.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static com.librax.lab.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static com.librax.lab.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("librax-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("librax-test");
