package com.librax.lab.module.iot.job.device;
...
import com.librax.lab.module.iot.framework.iot.config.LibraxIotProperties;
...
public class IotDeviceOfflineCheckJob implements JobHandler {
    ...
    @Resource
    private LibraxIotProperties iotProperties;
