package com.librax.lab.module.iot.core.messagebus.config;

import com.librax.lab.framework.mq.redis.core.RedisMQTemplate;
import com.librax.lab.framework.mq.redis.core.job.RedisPendingMessageResendJob;
import com.librax.lab.framework.mq.redis.core.job.RedisStreamMessageCleanupJob;
import com.librax.lab.framework.mq.redis.core.stream.AbstractRedisStreamMessage;
import com.librax.lab.framework.mq.redis.core.stream.AbstractRedisStreamMessageListener;
import com.librax.lab.module.iot.core.messagebus.core.IotMessageBus;
import com.librax.lab.module.iot.core.messagebus.core.local.IotLocalMessageBus;
import com.librax.lab.module.iot.core.messagebus.core.redis.IotRedisMessageBus;
import com.librax.lab.module.iot.core.messagebus.core.rocketmq.IotRocketMQMessageBus;
import com.librax.lab.module.iot.core.mq.producer.IotDeviceMessageProducer;
...
public class IotMessageBusAutoConfiguration {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "librax.iot.message-bus", name = "type", havingValue = "local", matchIfMissing = true)
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "librax.iot.message-bus", name = "type", havingValue = "rocketmq")
    ...
    /**
     * 特殊：由于 LibraxRedisMQConsumerAutoConfiguration 关于 Redis stream 的消费是动态注册，所以这里只能拷贝相关的逻辑！！！
     *
     * @see com.librax.lab.framework.mq.redis.config.LibraxRedisMQConsumerAutoConfiguration
     */
    @Configuration
    @ConditionalOnProperty(prefix = "librax.iot.message-bus", name = "type", havingValue = "redis")
