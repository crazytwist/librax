package com.librax.lab.module.iot.gateway.config;

import com.librax.lab.module.iot.core.messagebus.core.IotMessageBus;
import com.librax.lab.module.iot.gateway.protocol.emqx.IotEmqxAuthEventProtocol;
import com.librax.lab.module.iot.gateway.protocol.emqx.IotEmqxDownstreamSubscriber;
import com.librax.lab.module.iot.gateway.protocol.emqx.IotEmqxUpstreamProtocol;
import com.librax.lab.module.iot.gateway.protocol.http.IotHttpDownstreamSubscriber;
import com.librax.lab.module.iot.gateway.protocol.http.IotHttpUpstreamProtocol;
import com.librax.lab.module.iot.gateway.protocol.mqtt.IotMqttDownstreamSubscriber;
import com.librax.lab.module.iot.gateway.protocol.mqtt.IotMqttUpstreamProtocol;
import com.librax.lab.module.iot.gateway.protocol.mqtt.manager.IotMqttConnectionManager;
import com.librax.lab.module.iot.gateway.protocol.mqtt.router.IotMqttDownstreamHandler;
import com.librax.lab.module.iot.gateway.protocol.tcp.IotTcpDownstreamSubscriber;
import com.librax.lab.module.iot.gateway.protocol.tcp.IotTcpUpstreamProtocol;
import com.librax.lab.module.iot.gateway.protocol.tcp.manager.IotTcpConnectionManager;
import com.librax.lab.module.iot.gateway.service.device.IotDeviceService;
import com.librax.lab.module.iot.gateway.service.device.message.IotDeviceMessageService;
...
public class IotGatewayConfiguration {
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "librax.iot.gateway.protocol.http", name = "enabled", havingValue = "true")
    @Slf4j
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "librax.iot.gateway.protocol.emqx", name = "enabled", havingValue = "true")
    @Slf4j
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "librax.iot.gateway.protocol.tcp", name = "enabled", havingValue = "true")
    @Slf4j
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "librax.iot.gateway.protocol.mqtt", name = "enabled", havingValue = "true")
    @Slf4j
