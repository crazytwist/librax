...
@Schema(description = "管理后台 - 样本事件日志，全链路追踪，只INSERT不修改 [lab_sample_] Response VO")
@Data
@ExcelIgnoreUnannotated
public class SampleEventRespVO {
    ...
    @ExcelProperty("关联流程执行ID，非流程操作为NULL")
    private String executionId;

    @Schema(description = "关联节点ID", example = "17385")
    @ExcelProperty("关联节点ID")
    ...
    @ExcelProperty("事件类型：REGISTERED/RECEIVED/LOADED/SPLIT/MERGE/ALIQUOT/ADD_REAGENT/TRANSFER/BOUND_TO_STEP/MEASURING/MEASURED/COMPLETED/ARCHIVED/REJECTED/LOST/STATUS_CHANGED")
    ...
    @ExcelProperty("附加信息，如拆分明细、试剂信息、检测参数等")
