...
@Schema(description = "管理后台 - 样本主表，记录样本全生命周期信息：属性、状态、位置、流程关联新增/修改 Request VO")
@Data
public class SampleInfoSaveReqVO {
    ...
    @NotEmpty(message = "样本唯一业务ID（条码/二维码）不能为空")
    ...
    @NotEmpty(message = "样本类型：BLOOD/URINE/TISSUE/WATER/SOIL/AIR/MIXTURE不能为空")
