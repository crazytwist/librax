...
import com.librax.lab.framework.ip.core.utils.AreaUtils;
import com.librax.lab.module.member.api.address.dto.MemberAddressRespDTO;
import com.librax.lab.module.member.api.user.dto.MemberUserRespDTO;
import com.librax.lab.module.pay.api.order.dto.PayOrderCreateReqDTO;
import com.librax.lab.module.pay.enums.DictTypeConstants;
import com.librax.lab.module.product.api.comment.dto.ProductCommentCreateReqDTO;
import com.librax.lab.module.product.api.property.dto.ProductPropertyValueDetailRespDTO;
import com.librax.lab.module.product.api.sku.dto.ProductSkuRespDTO;
import com.librax.lab.module.product.api.sku.dto.ProductSkuUpdateStockReqDTO;
import com.librax.lab.module.product.api.spu.dto.ProductSpuRespDTO;
import com.librax.lab.module.promotion.api.combination.dto.CombinationRecordCreateReqDTO;
import com.librax.lab.module.trade.api.order.dto.TradeOrderRespDTO;
import com.librax.lab.module.trade.controller.admin.base.member.user.MemberUserRespVO;
import com.librax.lab.module.trade.controller.admin.base.product.property.ProductPropertyValueDetailRespVO;
import com.librax.lab.module.trade.controller.admin.order.vo.*;
import com.librax.lab.module.trade.controller.app.base.property.AppProductPropertyValueDetailRespVO;
import com.librax.lab.module.trade.controller.app.order.vo.*;
import com.librax.lab.module.trade.controller.app.order.vo.item.AppTradeOrderItemCommentCreateReqVO;
import com.librax.lab.module.trade.controller.app.order.vo.item.AppTradeOrderItemRespVO;
...
import com.librax.lab.module.trade.framework.delivery.core.client.dto.ExpressTrackRespDTO;
import com.librax.lab.module.trade.framework.order.config.TradeOrderProperties;
import com.librax.lab.module.trade.service.brokerage.bo.BrokerageAddReqBO;
...
import static com.librax.lab.framework.common.util.collection.CollectionUtils.convertMap;
import static com.librax.lab.framework.common.util.collection.CollectionUtils.convertMultiMap;
import static com.librax.lab.framework.common.util.date.LocalDateTimeUtils.addTime;
...
public interface TradeOrderConvert {
    ...
    default BrokerageAddReqBO convert(MemberUserRespDTO user, TradeOrderItemDO item,
        ...
        if (BooleanUtil.isTrue(spu.getSubCommissionType())) {
            // 特殊：单独设置的佣金需要乘以购买数量。关联 https://gitee.com/libraxcode/librax-mall-uniapp/issues/ICY7SJ
