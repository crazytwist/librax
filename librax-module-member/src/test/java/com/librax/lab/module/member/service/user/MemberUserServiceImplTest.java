...
import com.librax.lab.module.member.controller.app.user.vo.AppMemberUserUpdateMobileReqVO;
...
import com.librax.lab.module.member.service.auth.MemberAuthServiceImpl;
 ...
 */
@Disabled
@Import({MemberUserServiceImpl.class, LibraxRedisAutoConfiguration.class})
