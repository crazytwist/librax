package com.librax.lab.module.mp.service.account;
...
import com.librax.lab.module.mp.controller.admin.account.vo.MpAccountCreateReqVO;
import com.librax.lab.module.mp.controller.admin.account.vo.MpAccountPageReqVO;
import com.librax.lab.module.mp.controller.admin.account.vo.MpAccountUpdateReqVO;
import com.librax.lab.module.mp.convert.account.MpAccountConvert;
import com.librax.lab.module.mp.dal.dataobject.account.MpAccountDO;
import com.librax.lab.module.mp.dal.mysql.account.MpAccountMapper;
import com.librax.lab.module.mp.enums.ErrorCodeConstants;
import com.librax.lab.module.mp.framework.mp.core.MpServiceFactory;
...
import static com.librax.lab.module.system.enums.ErrorCodeConstants.USER_USERNAME_EXISTS;
    ...
    public void initLocalCache() {
        ...
        TenantUtils.executeIgnore(() -> {
            ...
            try {
                ...
                log.error("[微信公众号 librax-module-mp - 表结构未导入][参考 https://doc.iocoder.cn/mp/build/ 开启]");
            }
