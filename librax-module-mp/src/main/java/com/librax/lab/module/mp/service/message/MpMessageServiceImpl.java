package com.librax.lab.module.mp.service.message;

import cn.hutool.core.lang.Assert;
import cn.hutool.core.thread.ThreadUtil;
import cn.hutool.core.util.StrUtil;
import com.librax.lab.framework.common.pojo.PageResult;
import com.librax.lab.module.mp.controller.admin.message.vo.message.MpMessagePageReqVO;
import com.librax.lab.module.mp.controller.admin.message.vo.message.MpMessageSendReqVO;
import com.librax.lab.module.mp.convert.message.MpMessageConvert;
import com.librax.lab.module.mp.dal.dataobject.account.MpAccountDO;
import com.librax.lab.module.mp.dal.dataobject.message.MpMessageDO;
import com.librax.lab.module.mp.dal.dataobject.user.MpUserDO;
import com.librax.lab.module.mp.dal.mysql.message.MpMessageMapper;
import com.librax.lab.module.mp.enums.message.MpMessageSendFromEnum;
import com.librax.lab.module.mp.framework.mp.core.MpServiceFactory;
import com.librax.lab.module.mp.framework.mp.core.util.MpUtils;
import com.librax.lab.module.mp.service.account.MpAccountService;
import com.librax.lab.module.mp.service.material.MpMaterialService;
import com.librax.lab.module.mp.service.message.bo.MpMessageSendOutReqBO;
import com.librax.lab.module.mp.service.user.MpUserService;
...
import static com.librax.lab.module.mp.enums.ErrorCodeConstants.MESSAGE_SEND_FAIL;
