package com.librax.lab.module.pay.convert.order;
...
public interface PayOrderConvert {
    ...
    PayOrderSubmitRespVO convert(PayOrderDO order, com.librax.lab.module.pay.framework.pay.core.client.dto.order.PayOrderRespDTO respDTO);
