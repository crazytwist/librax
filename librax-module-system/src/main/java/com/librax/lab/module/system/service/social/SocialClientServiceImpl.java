package com.librax.lab.module.system.service.social;
...
import com.librax.lab.framework.common.util.cache.CacheUtils;
import com.librax.lab.framework.common.util.http.HttpUtils;
import com.librax.lab.framework.common.util.object.BeanUtils;
import com.librax.lab.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.librax.lab.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import com.librax.lab.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import com.librax.lab.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import com.librax.lab.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import com.librax.lab.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.librax.lab.module.system.dal.dataobject.social.SocialClientDO;
import com.librax.lab.module.system.dal.mysql.social.SocialClientMapper;
import com.librax.lab.module.system.dal.redis.RedisKeyConstants;
import com.librax.lab.module.system.enums.social.SocialTypeEnum;
import com.librax.lab.module.system.framework.justauth.core.AuthRequestFactory;
...
import static com.librax.lab.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static com.librax.lab.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${librax.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${librax.wxa-subscribe-message.miniprogram-state:formal}")
