package com.librax.lab.module.system.service.user;

import cn.hutool.core.util.RandomUtil;
import com.librax.lab.framework.common.enums.CommonStatusEnum;
import com.librax.lab.framework.common.exception.ServiceException;
import com.librax.lab.framework.common.pojo.PageResult;
import com.librax.lab.framework.common.util.collection.ArrayUtils;
import com.librax.lab.framework.common.util.collection.CollectionUtils;
import com.librax.lab.framework.test.core.ut.BaseDbUnitTest;
import com.librax.lab.module.infra.api.config.ConfigApi;
import com.librax.lab.module.infra.api.file.FileApi;
import com.librax.lab.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import com.librax.lab.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import com.librax.lab.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import com.librax.lab.module.system.controller.admin.user.vo.user.UserImportRespVO;
import com.librax.lab.module.system.controller.admin.user.vo.user.UserPageReqVO;
import com.librax.lab.module.system.controller.admin.user.vo.user.UserSaveReqVO;
import com.librax.lab.module.system.dal.dataobject.dept.DeptDO;
import com.librax.lab.module.system.dal.dataobject.dept.PostDO;
import com.librax.lab.module.system.dal.dataobject.dept.UserPostDO;
import com.librax.lab.module.system.dal.dataobject.tenant.TenantDO;
import com.librax.lab.module.system.dal.dataobject.user.AdminUserDO;
import com.librax.lab.module.system.dal.mysql.dept.UserPostMapper;
import com.librax.lab.module.system.dal.mysql.user.AdminUserMapper;
import com.librax.lab.module.system.enums.common.SexEnum;
import com.librax.lab.module.system.service.dept.DeptService;
import com.librax.lab.module.system.service.dept.PostService;
import com.librax.lab.module.system.service.oauth2.OAuth2TokenService;
import com.librax.lab.module.system.service.permission.PermissionService;
...
import static com.librax.lab.framework.common.util.collection.SetUtils.asSet;
import static com.librax.lab.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static com.librax.lab.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static com.librax.lab.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static com.librax.lab.framework.test.core.util.AssertUtils.assertPojoEquals;
import static com.librax.lab.framework.test.core.util.AssertUtils.assertServiceException;
import static com.librax.lab.framework.test.core.util.RandomUtils.*;
import static com.librax.lab.module.system.enums.ErrorCodeConstants.*;
import static com.librax.lab.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("libraxyuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("libraxyuanma");
        ...
        assertEquals("libraxyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("libraxyuanma"))).thenReturn("java");
