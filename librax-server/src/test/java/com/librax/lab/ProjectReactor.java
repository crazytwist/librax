...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.librax.boot";
    private static final String ARTIFACT_ID = "librax";
    private static final String PACKAGE_NAME = "com.librax.lab";
    private static final String TITLE = "Librax实验室智慧管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.librax.boot";
        String artifactIdNew = "librax";
        String packageNameNew = "com.librax.lab";
        String titleNew = "Librax实验室智慧管理系统";
